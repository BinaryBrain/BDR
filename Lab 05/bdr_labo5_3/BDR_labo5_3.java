...
public class BDR_labo5_3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Entez votre no de staff");
            NoStaff = bufferRead.readLine();
            System.out.println("You entered " + NoStaff);
            String sqlStror = "SELECT store_id FROM staff where staff_id = '" + NoStaff + "'";
            ...
            System.out.println("Entez un nom d'acteur");
            actor_name = bufferRead.readLine();
            String sqlActors = "SELECT * FROM actor where last_name = '" + actor_name + "'";
            ...
            if (list.size() > 0) {
                ...
                while (choixCorr) {
                    ...
                    if (Integer.parseInt(choix) - 1 < list.size()) {
                        ...
                        System.out.println(list.get(Integer.parseInt(choix) - 1));
                ...
                if (listActorFilm.size() > 0) {
                    ...
                    while (choixCorr) {
                        ...
                        if (Integer.parseInt(choix) - 1 < list.size()) {
                            ...
                            System.out.println(listActorFilm.get(Integer.parseInt(choix) - 1));
                            oChoix = listActorFilmID.get(Integer.parseInt(choix) - 1);
                    ...
                    if (listExemplaireFilm.size() > 0) {
                        ...
                        while (choixCorr) {
                            ...
                            if (Integer.parseInt(choix) - 1 < list.size()) {
                                ...
                                System.out.println(listExemplaireFilm.get(Integer.parseInt(choix) - 1));
                                oChoix = listExemplaireFilm.get(Integer.parseInt(choix) - 1);
                                ...
                                String sqlClent = "SELECT customer_id FROM `customer` where first_name = '" + prenom + "' AND last_name = '" + nom + "'";
                                ...
                                if (customer_id == null) {
                                    ...
                                    //new country
                                    if (pays_id == null) {
                                        String resultat = "INSERT INTO country (country) VALUES('" + pays + "');";
                                        stmt.executeUpdate(resultat, Statement.RETURN_GENERATED_KEYS);
                                        rs = stmt.getGeneratedKeys();
                                        int dernierId_pays = 0;
                                        if (rs != null && rs.first()) {
                                            dernierId_pays = rs.getInt(1);
                                        }
                                        pays_id = Integer.toString(dernierId_pays);
                                    }

                                    System.out.println("Votre ville :");
                                    String ville = bufferRead.readLine();
                                    String sqlVille = "SELECT * FROM `city` where country = " + ville;
                                    rs = stmt.executeQuery(sqlClent);
                                    ...
                                    if (ville_id == null) {
                                        ...
                                        String resultat = "INSERT INTO city (city, country_id) VALUES('" + ville + "' , '" + pays_id + "')";
                                        stmt.executeUpdate(resultat, Statement.RETURN_GENERATED_KEYS);
                                        rs = stmt.getGeneratedKeys();
                                        ...
                                        ville_id = Integer.toString(dernierId_ville);
                                    }
                                    ...
                                    String resultat = "INSERT INTO address (address, city_id,district, phone) "
                                            + "VALUES('" + address + "', '" + ville_id + "' , '" + district + "', '" + phone + "')";
                                    stmt.executeUpdate(resultat, Statement.RETURN_GENERATED_KEYS);
                                    ...
                                    preparedStatement.setString(5, Integer.toString(dernierId_address));
                                    preparedStatement.executeUpdate();

                                }
                                rs = stmt.executeQuery("select * from sakila.customer where first_name ='" + prenom + "';");
                                ...
                                rs = stmt.executeQuery("select count(return_date) from rental where return_date IS NULL and customer_id = customer_id");
                                String NBlocation = "";
                                while (rs.next()) {
                                ...
                                if (Integer.parseInt(NBlocation) < 10) {
                                    ...
                                    time = new Timestamp(System.currentTimeMillis());
                                    preparedStatement.setTimestamp(2, time);
                                    preparedStatement.setString(3, (String) oChoix);
                                    preparedStatement.setString(4, NoStaff);
